...
var PrimaryBlue = Color(0xFF4F8CFF)
var PrimarySoft = Color(0xFF9BD7FF)
...
private fun applyThemeTokens(dark: Boolean) {
    if (dark) {
        ...
        PrimaryBlue = Color(0xFF4F8CFF)
        PrimarySoft = Color(0xFF9BD7FF)
        MoneyGreen = Color(0xFF38E68B)
        WarningAmber = Color(0xFFFFC857)
        LossRed = Color(0xFFFF6B7A)
    } else {
        ...
        PrimaryBlue = Color(0xFF1769E0)
        PrimarySoft = Color(0xFF006BBD)
        MoneyGreen = Color(0xFF008D5A)
        WarningAmber = Color(0xFFE07A00)
        LossRed = Color(0xFFD62F4B)
    }
}
